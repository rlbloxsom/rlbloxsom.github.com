	...
	<section class='nav-wrapper'>
		<nav class='project-list'>
			...
			<ul>
				...
				<li><a href='#a' class='project-on'>Cutting Board Magazine</a></li>
			</ul>
		</nav>
	</section>
