...
<div id='bgimage' class='info-on'>
	<img class="first" src="portfolioimages/typeimagephotos/bg1.jpg">
	<img src="portfolioimages/typeimagephotos/bg2.jpg">
	<img src="portfolioimages/typeimagephotos/bg3.jpg">
</div>
</div>
...
?>
	...
	<div id='menu-wrapper' class='clearfix'>
		<section class='contact-info'>
				<p>w:617.555.5555</p>
				<p>c:860.459.8124</p>
				<p>e:<a href="mailto:studio@rickybloxsom.com">studio@rickybloxsom.com</a></p>
		</section>
	...
	<section class='nav-wrapper'>
		<nav class='project-list'>
			...
			<ul>
				...
				<li><a class='page-on' href='Index_TypeImageBook.php'>Type and Image Book</a></li>
	    ...
	    <!--<script src='js/load_bar.js'></script>--!>
	...
	<div id='portfolio-wrapper' class='clearfix'>
	    ...
	    <p class='hide'>&#8212;</p>
 	    ...
 	    <section class="content-description" class='clearfix'>
		    <h1>Project:</h1>
 		    <h2>Typography and Image Booklet</h2>
		    <h3>Typography 2 Class</h3>
		    <h3>March 2009</h3>
 	    </section>
 	    
 	    <nav class='project-nav'>
 		    <a class='no-hover' id="prev" href="#"><u>Prev</u>(<b>◀</b>)</a> / 
 		    <a class='no-hover' id="next" href="#"><u>Next</u>(<b>▶</b>)</a> 
 	    ...
 	    <section class="content" class='clearfix'>
		    ...
		    <p class='copy'>To see more of Nick Brandt's work, visit his website at: <a target=”_blank” class='link' href='www.nickbrandt.com'>www.nickbrandt.com</a></p>
		    <p>&#8212;</p>
		    <p class='share'>Share on <a target=”_blank” href='#'>[FB]</a> <a target=”_blank” href='http://twitter.com/home?status=Look at this project by Boston-based designer, Ricky Bloxsom: www.rickybloxsom.com/typeimagebook'>[TW]</a> <a href="mailto:?subject=Typography%20and%20Image%20Booklet%20by%20Ricky%20Bloxsom&amp;body=I%20found%20this%20on%20the%20website%20of%20Boston-designer,%20Ricky%20Bloxsom%20and%20I%20thought%20that%20you%20might%20like%20to%20see%20it.%20www.rickybloxsom.com/typeimagebook%20—%20All%20work%20©%20Ricky%20Bloxsom%20—%20www.rickybloxsom.com">[Email]</a></p>
	    </section>
	
	    <p>&#8212;</p>
	
	    <section id='showhide' class='clearfix'>
