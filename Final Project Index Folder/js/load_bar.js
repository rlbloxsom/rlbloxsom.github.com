...
if (winW >= 1280) {
	...
	var bar_length = 1280*.2; // the bar will be this many pixels long
	//alert('large, window width = '+winW+', bar_length = '+bar_length);
	
} else if (winW < 1280 && winW >= 768) {

	var bar_length = winW*.2;
	//alert('medium, window width = '+winW+', bar_length = '+bar_length);
	
} else {

	var bar_length = 768*.2;
	//alert('small, window width = '+winW+', bar_length = '+bar_length);
...
var bar_height = 10; // the bar will be this many pixels high
var bar_color = "white"; // the progress bar color
var bar_background = "none"; // the color of the empty part of bar
var bar_border = "none";  // the color of the bar border
var window_background = "none"; // the color of the pop-up window
var window_border = "none"; // the border color of pop-up window
...
function setup_bar()
{
	...
	document.write('<div id="bar_window" style="'
		+ 'top: ' + (0) + 'px'
		+ ';left: ' + (0) + 'px'
	...
	border */
	document.write('<div id="empty_bar" style="'
		+ 'top: ' + 25 + 'px'
		+ ';left: ' + 25 + 'px'
		+ ';width: ' + bar_width2 + 'px'
	...
	document.write('<div id="bar" style="'
		+ 'top: ' + 26 + 'px'
		+ ';left: ' + 26 + 'px'
	...
	document.write('<div id="percent" style="'
		+ 'top: ' + 25 + 'px'
		+ ';width: ' + window_width + 'px'
		+ ';color: ' + text_color
		+ ';font-size: ' + .8 + 'em'
