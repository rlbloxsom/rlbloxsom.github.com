...
<body> <!--contain image-->
	<div id='bgimage'>
<img src="portfolioimages/themeal/bg1.jpg" style="top: 0px; left: 0px; opacity: 1; z-index: -1;">
<img src="portfolioimages/themeal/bg2.jpg" style="top: 0px; left: 0px; z-index: -1; position: absolute; opacity: 0; display: none;">
<img src="portfolioimages/themeal/bg3.jpg" style="top: 0px; left: 0px; z-index: -1; position: absolute; opacity: 0; display: none;">
	</div>
...
?>
	...
	<section class='nav-wrapper'>
		<nav class='project-list'>
			...
			<ul>
				...
				<li><a href='#a' class='project-on'>“The Meal” Recipes and Packaging</a></li>
	...
	<div id='portfolio-wrapper' class='clearfix'>
 	...
 	<section class="content-description" class='clearfix'>
		<h1>Description:</h1>
 		<h2>"The Meal" Recipe Cards and Packaging</h2>
		<h1>Client:</h1>
		<h2>Typography 2</h2>
		<h1>Date:</h1>
		<h2>February 2009</h2>
 	...
 	<section class="content-description" class='clearfix'>
 		...
 		<p class='copy'>To package these recipe I wrapped the cards in black paper (like meat from a butcher) and tied if with twine. A small tag is attached with the product name.</p>
		<p class='share'>Share on <a href='#'>[FB]</a><a href='http://twitter.com/home?status=Look at this project by Boston-based designer, Ricky Bloxsom: www.rickybloxsom.com/themeal'> [TW]</a><a  href="mailto:?subject=The%20Meal%20Recipe%20Set%20by%20Ricky%20Bloxsom&amp;body=I%20found%20this%20on%20the%20website%20of%20Boston-designer,%20Ricky%20Bloxsom%20and%20I%20thought%20that%20you%20might%20like%20to%20see%20it.%20www.rickybloxsom.com/themeal%20—%20All%20work%20©%20Ricky%20Bloxsom%20—%20www.rickybloxsom.com" > [Email]</a></p>
	</section>
